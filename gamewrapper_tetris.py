...
init_screen = torch.from_numpy(np.asarray(tetris.game_area(), dtype='float32')).to(device)
...
for i_episode in range(num_episodes):
    ...
    tetris.reset_game()
    last_screen = torch.from_numpy(np.asarray(tetris.game_area(), dtype='float32')).to(device)
    current_screen = torch.from_numpy(np.asarray(tetris.game_area(), dtype='float32')).to(device)
